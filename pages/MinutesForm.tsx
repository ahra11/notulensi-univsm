...
const MinutesForm: React.FC<MinutesFormProps> = ({ onNavigate, initialData }) => {
    ...
    const stopRecording = () => {
        if (mediaRecorderRef.current && isRecording) {
            ...
            setStatusMessage("Sedang memproses audio...");
        }
    };
        ...
        try {
            ...
            reader.onloadend = async () => {
                ...
                const response = await ai.models.generateContent({
                    ...
                    contents: {
                        parts: [
                            { text: "Transkripsikan audio rapat ini ke Bahasa Indonesia formal. Fokus pada poin-poin penting." },
                ...
                setStatusMessage("Transkripsi selesai.");
